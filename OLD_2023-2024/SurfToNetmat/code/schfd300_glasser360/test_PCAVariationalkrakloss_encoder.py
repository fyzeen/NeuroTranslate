...
if __name__ == "__main__":
    ...
    model_type = "PCAVAEKraklossEncoder"
    out_nodes = 360
    ...
    model = VariationalTransformerEncoder_Netmat(dim_model=100,
                                                 input_dim=44850,
                                                 model_len=150,
                                                 depth=6,
                                                 nhead=10,
    ...
    # reset params 
    model.load_state_dict(torch.load(f"/scratch/ahmadf/NeuroTranslate/SurfToNetmat/saved_models/{translation}/{model_type}_580.pt"))
