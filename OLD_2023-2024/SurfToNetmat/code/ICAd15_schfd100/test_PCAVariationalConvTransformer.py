...
if __name__ == "__main__":
    ...
    model_type = "TestPCAVariationalConvTransformer"
    out_nodes = 100
    ...
    model.load_state_dict(torch.load(f"/scratch/ahmadf/NeuroTranslate/SurfToNetmat/saved_models/{translation}/PCAVariationalConvTransformer_30.pt"))
    ...
    train_mse, train_mae, test_mse, test_mae, train_corr, test_corr, train_corr_list, test_corr_list = test(model, train_loader_fortesting, test_loader, device, pca, mean_train_label)
