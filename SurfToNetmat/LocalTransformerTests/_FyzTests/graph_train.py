...
if __name__ == "__main__":
    ...
    # write to file
    write_fpath = "/home/ahmadf/batch/sbatch.printGraph_Model"
    ...
    for epoch in range(1, 601):
        ...
        torch.save(model.state_dict(), f"/home/ahmadf/NeuroTranslate/code/SurfToNetmat/TransformerTest/_FyzTests/TrainedModels/GraphModel_{epoch}.pt")

        delete = f"/home/ahmadf/NeuroTranslate/code/SurfToNetmat/TransformerTest/_FyzTests/TrainedModels/GraphModel_{epoch-2}.pt"
