...
if __name__ == "__main__":
    ...
    for epoch in range(1, 201):
        ...
        torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d50_to_gradients_d50/", f"SPLINECONV_recentEPOCH_ICA_d50_to_gradients_d50.pt")) 

        if epoch % 20 == 0:
            torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d50_to_gradients_d50/", f"SPLINECONV_EPOCH{epoch}_ICA_d50_to_gradients_d50.pt")) 
    ...
    torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d50_to_gradients_d50/", "SPLINECONV_FINAL_ICA_d50_to_gradients_d50.pt")) 
