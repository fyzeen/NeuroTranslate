...
if __name__ == "__main__":
    ...
    model_type = "PCAVanillaKrakencoder_BigLinear"
    out_nodes = 360
    ...
    input_pca = PCA(n_components=256)
    input_pca.fit(train_mesh_flat)
    train_data_transform = input_pca.transform(train_mesh_flat)
    test_data_transform = input_pca.transform(test_mesh_flat)
