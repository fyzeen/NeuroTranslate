...
if __name__ == "__main__":
    ...
    model = ProjectionConvTransformerNetmat(dim_model=100,
                                            encoder_input_dim=44850,
                                            encoder_model_len=150,
                                            encoder_depth=6,
                                            nhead_encoder=10,
                                            encoder_mlp_dim=250,
                                            decoder_input_dim=264,
                                            nhead_decoder=10,
                                            decoder_dim_feedforward=250,
                                            decoder_depth=6,
                                            latent_length=33,
                                            dropout=0.1)
    ...
    # reset params 
    model.load_state_dict(torch.load(f"/scratch/ahmadf/NeuroTranslate/SurfToNetmat/saved_models/{translation}/{model_type}_90.pt"))
