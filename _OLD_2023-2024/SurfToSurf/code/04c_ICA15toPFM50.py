...
if __name__ == "__main__":
    ...
    dataset = TranslationsData(x_type="ICA", numFeatures_x=15,
    ...
    for epoch in range(1, 201):
        ...
        torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d15_to_profumo_d50/", f"SPLINECONV_recentEPOCH_ICA_d15_to_profumo_d50.pt")) 

        if epoch % 20 == 0:
            torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d15_to_profumo_d50/", f"SPLINECONV_EPOCH{epoch}_ICA_d15_to_profumo_d50.pt")) 
    ...
    torch.save(model.state_dict(), op.join("/home/ahmadf/NeuroTranslate/saved_models/ICA_d15_to_profumo_d50/", "SPLINECONV_FINAL_ICA_d15_to_profumo_d50.pt")) 