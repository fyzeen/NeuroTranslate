...
if __name__ == "__main__":
    ...
    dataset = TranslationsData(x_type="gradients", numFeatures_x=50,
    ...
    def write_to_file(content):
        with open('/home/ahmadf/batch/sbatch.print4', 'a') as file:
    ...
    for epoch in range(1, 20):
        ...
        torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/gradients_d50_to_ICA_d50/", f"largerGCNCONV_recentEPOCH_gradients_d50_to_ICA_d50.pt")) 

        if epoch % 20 == 0:
            torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/gradients_d50_to_ICA_d50/", f"largerGCNCONV_EPOCH{epoch}_gradients_d50_to_ICA_d50.pt")) 
    ...
    torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/gradients_d50_to_ICA_d50/", "largerGCNCONV_FINAL_gradients_d50_to_ICA_d50.pt")) 
