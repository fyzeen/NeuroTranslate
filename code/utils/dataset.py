...
def extract_cortexData(data=None, numFeatures=None):
    ...
    cortex: numpy.ndarray
        Data stored in each vertex in the CORTEX, with shape [64984 (num cortical vertices), numFeatures]
...
def read_Subj(x=None, y=None, numFeatures_x=None, numFeatures_y=None, brain_shape=None):
    ...
    coordinates = hcp.mesh[brain_shape][0] # Coordinates (pos) of vertices in HCP S1200 group average meshes per https://github.com/rmldj/hcp-utils/blob/master/hcp_utils/hcp_utils.py
