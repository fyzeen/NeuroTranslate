...
if __name__ == "__main__":
    ...
    def write_to_file(content):
        with open('/home/ahmadf/batch/sbatch.print8', 'a') as file:
    ...
    for epoch in range(1, 20):
        ...
        torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/ICA_d200_to_gradients_d50/", f"GMMCONV_recentEPOCH_ICA_d200_to_gradients_d50.pt")) 

        if epoch % 20 == 0:
            torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/ICA_d200_to_gradients_d50/", f"GMMCONV_EPOCH{epoch}_ICA_d200_to_gradients_d50.pt")) 
    ...
    torch.save(model.state_dict(), op.join("/scratch/ahmadf/NeuroTranslate/saved_models/ICA_d200_to_gradients_d50/", "GMMCONV_FINAL_ICA_d200_to_gradients_d50.pt")) 
